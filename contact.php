...
<html lang="en">
 <head>
     <title>Karina Ibarra: Responsive Website</title>
  <meta charset="utf-8" />
   ...
   <main class="wrapper">
     ...
     -->  
        ...
        */
        ...
        $to  = 'karina.ibarra616@gmail.com';//put your email here
     ...
     <footer>
      <p><small>&copy; 2019 by <a href="contact.php">Contact Karina Ibarra </a>, All Rights Reserved ~ <a href="http://validator.w3.org/check/referer" target="_blank">Valid HTML</a> ~ <a href="http://jigsaw.w3.org/css-validator/check?uri=referer" target="_blank">Valid CSS</a></small></p>
    </footer>
  </main>
